...
//         <div>
//           {users.map(user => (
//             <div key={user.id} className="bg-white shadow-lg shadow-[gray] rounded-lg p-4">
...
//               <p className="mb-2 text-[green]"><strong>Status:</strong> {user.status == null ? 'Order Requested' : user.status}</p>
//             </div>
//           ))}
//         </div>
//       </div>
